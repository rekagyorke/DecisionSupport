<?php 
	$cities = array("A0"=>"Athens, Greece" , "A1"=>"Paris, France" ,"A2"=>"Rome, Italy" ,"A3"=>"Barcelona, Spain" , "A4"=>"Prague, Czech Rep");
	
	$price = array(
				array( 1   , 3 , 2   , 2   , 0.5  ),
				array( 0.33, 1 , 0.5 , 0.5 , 0.33 ),
				array( 0.5 , 2 , 1   , 2   , 0.33 ),
				array( 0.5 , 2 , 0.5 , 1   , 0.5  ),
				array( 2   , 3 , 3   , 2   , 1    ));
	
	$distance = array(
					array( 1    , 3    , 2    , 5 , 0.33 ),
					array( 0.33 , 1    , 0.5  , 4 , 0.25 ),
					array( 0.5  , 2    , 1    , 4 , 0.33 ),
					array( 0.2  , 0.25 , 0.25 , 1 , 0.16 ),
					array( 3    , 4    , 3    , 6 , 1    ));
	
	$entertainment = array(
						array( 1 , 0.5 , 0.5 , 0.5 , 0.5 ),
						array( 2 , 1   , 2   , 2   , 2   ),
						array( 2 , 0.5 , 1   , 0.5 , 0.5 ),
						array( 2 , 0.5 , 2   , 1   , 2   ),
						array( 2 , 0.5 , 2   , 0.5 , 1   ));						
