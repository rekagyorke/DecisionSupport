<?php 
	...
	$cities = array("A0"=>"Cote d'Azur, France" , "A1"=>"Dubrovnik, Croatia" , "A2"=>"Crete, Greece" ,"A3"=>"Antalya, Turkey" , "A4"=>"Barcelona, Spain");
	
	$price = array(
				array( 1 , 0.16 , 0.16 , 0.12 , 0.2 ),
				array( 6 , 1    , 0.33 , 0.16 , 0.5 ),
				array( 6 , 3    , 1    , 0.16 , 0.5 ),
				array( 8 , 6    , 6    , 1    , 7   ),
				array( 5 , 2    , 2    , 0.14 , 1   ));
	...
	$distance = array(
					array( 1    , 0.33 , 2    , 2    , 4  ),
					array( 3    , 1    , 3    , 3    , 5  ),
					array( 0.5  , 0.33 , 1    , 0.5  , 3  ),
					array( 0.5  , 0.33 , 2    , 1    , 33 ),
					array( 0.25 , 0.2  , 0.33 , 0.33 , 1  ));
	
	$entertainment = array(
						array( 1   , 0.33 , 0.5  , 0.5  , 2 ),
						array( 3   , 1    , 2    , 2    , 3 ),
						array( 2   , 0.5  , 1    , 2    , 4 ),
						array( 2   , 0.5  , 0.5  , 1    , 3 ),
						array( 0.5 , 0.33 , 0.25 , 0.33 , 1 ));						
